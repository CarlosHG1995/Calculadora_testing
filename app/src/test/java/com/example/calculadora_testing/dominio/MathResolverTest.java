...
public class MathResolverTest {
    ...
    private Object[] calculateData() {
        return new Object[]{
                ...
                new Object[] {new String[]{"2.3", "+"}, 2.3d},//no pasa
                ...
                new Object[] {new String[]{"2", "+", "3", "+"}, 5d},//no pasa
                new Object[] {new String[]{"5.7", "+", "2.2", "-"}, 7.9d},//no pasa
                new Object[] {new String[]{"6", "/", "3", "+"}, 2d},//no pasa
                new Object[] {new String[]{"6", "+", "3", "x"}, 9d},//no pasa
                new Object[] {new String[]{"2", "+", "2", "x"}, 4d},//no pasa
                new Object[] {new String[]{"f", "4", "x", "r"}, 24d},
                new Object[] {new String[]{"2", "x", "-", "3", "+"}, -6d},//no pasa
                new Object[] {new String[]{"2", "+", "-", "3", "x"}, -1d},//no pasa
                new Object[] {new String[]{"2", "+", "2", "x", "3"}, 8d},//no pasa
                ...
                new Object[] {new String[]{"2", "x", "3", "+", "r", "49", "x"}, 13d},//no pasa
                new Object[] {new String[]{"25", "/", "5", "x", "3", "+", "r", "81", "x", "2", "^", "4", "+", "f", "3", "/", "3"}, 161d},//no pasa
                new Object[] {new String[]{"-2", "^", "-3"}, -0.125d}
        };
    }
